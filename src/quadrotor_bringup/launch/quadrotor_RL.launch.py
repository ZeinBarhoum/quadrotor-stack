...
def generate_launch_description():
    ...
    config_file = os.path.join(config_folder, 'simulation_rl.yaml')
    ...
    rl_controller_parameters = parameters['RLController']
    ...
    rl_controller_node = Node(
        ...
        executable='quadrotor_rl',
        output='screen',
        parameters=[rl_controller_parameters]
    )
