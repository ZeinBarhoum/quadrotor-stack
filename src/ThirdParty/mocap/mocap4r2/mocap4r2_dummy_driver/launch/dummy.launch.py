...
def generate_launch_description():
    ...
    params_file_path = os.path.join(get_package_share_directory(
        'mocap4r2_dummy_driver'), 'config', 'mocap4r2_dummy_driver_params.yaml')
    ...
    driver_node = LifecycleNode(
        name='mocap4r2_dummy_driver_node',
        namespace='',
        package='mocap4r2_dummy_driver',
        executable='mocap4r2_dummy_driver_main',
        output='screen',
